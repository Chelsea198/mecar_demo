...
class UITextStyle {
  static const TextStyle white_16w400 = TextStyle(
    fontFamily: "SFUIText",
  ...
  static const TextStyle errigalWhite_16w400 = TextStyle(
    fontFamily: "SFUIText",
    fontWeight: FontWeight.w600,
    fontSize: 16,
    color: UIColor.errigalWhite,
  );

  static const TextStyle blackWash_14w400 = TextStyle(
    fontFamily: "SFUIText",
    fontWeight: FontWeight.w400,
    fontSize: 14,
  ...
  static const TextStyle blackWash_20w400 = TextStyle(
    fontFamily: "SFUIText",
    fontWeight: FontWeight.w400,
    fontSize: 20,
    color: UIColor.blackWash,
  ...
  static const TextStyle blueSparkle_14w400 = TextStyle(
    fontFamily: "SFUIText",
    fontWeight: FontWeight.w400,
    fontSize: 14,
  ...
  static const TextStyle grey_14w400 = TextStyle(
    fontFamily: "SFUIText",
    fontWeight: FontWeight.w400,
    fontSize: 14,
    color: UIColor.hintTextColor,
